export const cheackValidSignIn=(email,password)=>{
    ...
    if(!isEmailValid && !isPasswordVaild) return "Email Id and Password is invaild"
...
export const cheackValidSignUp=(name, email,password)=>{
    ...
    if(!isEmailValid && !isPasswordVaild && !isNameValid) return "Name, Email Id and Password is invaild"
